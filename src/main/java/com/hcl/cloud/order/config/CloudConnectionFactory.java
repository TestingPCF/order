...
public class CloudConnectionFactory extends AbstractCloudConfig {
    ...
    public MongoDbFactory mongoDbFactory(){
        MongoClient mongoClient = new MongoClient("d46de95-mongodb-0.node.dc1.a9s-mongodb-consul"
                , 27017);
        UserCredentials credentials = new UserCredentials("a9s-brk-usr-b1786eb95e105117cdbc7e37c5686f14dfa7204d"
